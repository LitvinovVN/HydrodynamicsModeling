...
void Grid2DTransferPlaneXOZFragmentTest03(LinearArray3D* linearArray_next, LinearArray3D* linearArray_prev, LinearArray2D* planeXOZForward)
{      
...
{    
    ...
    for (int fragmentNx_prev = 10; fragmentNx_prev <= 100; fragmentNx_prev = fragmentNx_prev + 10)
    {
        for (int fragmentNz_prev = 10; fragmentNz_prev <= 100; fragmentNz_prev = fragmentNz_prev + 10)
        {
            ...
            algStartTransferFragmentTesting(Grid2DTransferPlaneXOZFragmentTest03, linearArray_next, linearArray_prev, planeXOZForward, 20);
