...
void algStartTransferFragmentTesting_2(void (*algFunPntr)(LinearArray3D*, LinearArray3D*),
...
void Grid2DTransferPlaneXOYFragmentTest04(LinearArray3D* linearArray_next, LinearArray3D* linearArray_prev)
{
    linearArray_prev->LinearArray3DTrasferXOYForward(linearArray_next);
}
#pragma endregion
...
void transferFragmentXOYTesting04()
{
    ...
    for (int fragmentNx_prev = 10; fragmentNx_prev <= 100; fragmentNx_prev = fragmentNx_prev + 10)
    {
        for (int fragmentNy_prev = 10; fragmentNy_prev <= 100; fragmentNy_prev = fragmentNy_prev + 10)
        {
            ...
            algStartTransferFragmentTesting_2(Grid2DTransferPlaneXOYFragmentTest04, linearArray_next, linearArray_prev, 20);
        }
    }
