...
void algStartTransferFragmentTesting_3(void (*algFunPntr)(LinearArray3D*, LinearArray3D*),
    LinearArray3D* linearArray_next, LinearArray3D* linearArray_prev, int numberOfLaunches)
{
...
void Grid2DTransferPlaneYOZFragmentTest06(LinearArray3D* linearArray_next, LinearArray3D* linearArray_prev)
{
...
void transferFragmentYOZTesting06()
{
    ...
    for (int fragmentNy_prev = 10; fragmentNy_prev <= 100; fragmentNy_prev = fragmentNy_prev + 10)
    {
        for (int fragmentNz_prev = 10; fragmentNz_prev <= 100; fragmentNz_prev = fragmentNz_prev + 10)
        {
            ...
            algStartTransferFragmentTesting_3(Grid2DTransferPlaneYOZFragmentTest06, linearArray_next, linearArray_prev, 20);
        }
    }
