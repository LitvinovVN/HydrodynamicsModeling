...
void algStartTransferFragmentTesting_3(void (*algFunPntr)(LinearArray3D*, LinearArray3D*, LinearArray2D*), LinearArray3D* linearArray_next,
    LinearArray3D* linearArray_prev, LinearArray2D* planeYOZForward, int numberOfLaunches)
{
	...
	{
		aTimer.start();
		algFunPntr(linearArray_next, linearArray_prev, planeYOZForward);
...
void Grid2DTransferPlaneYOZFragmentTest07(LinearArray3D* linearArray_next, LinearArray3D* linearArray_prev, LinearArray2D* planeYOZForward)
{      
    linearArray_prev->SetPlaneYOZLast(planeYOZForward);
    linearArray_next->GetPlaneYOZFirst(planeYOZForward);
}
#pragma endregion
...
{    
    ...
    for (int fragmentNy_prev = 10; fragmentNy_prev <= 100; fragmentNy_prev = fragmentNy_prev + 10)
    {
        ...
        {
            std::cout << "-------------------------fragmentNy_prev = " << fragmentNy_prev << "    fragmentNz_prev = " << fragmentNz_prev << std::endl;
            ...
            algStartTransferFragmentTesting_3(Grid2DTransferPlaneYOZFragmentTest07, linearArray_next, linearArray_prev, planeYOZForward, 20);
